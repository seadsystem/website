function ShempGraph(renderTo, min, max) {
   this.min = min;
   this.max = max;
   this.sensors = {};
   this.live = false;
   ...
   this.chart = new Highcharts.StockChart({
      chart: {
         ...
         //tells which div id to render to
         renderTo: renderTo,
         //line graph
         type: "line",
         zoomType: 'x',
      ...
      //enables the color coded description of the lines (ac voltage etc..)
      legend : {
         enabled : true
      },
      title: {
      ...
      //this.hideZoomBar(this);
   });
}

ShempGraph.prototype.hideZoomBar = function(chart) {
...
function fixGaps(data) {
   ...
   $.each(data, function(index, sensor_data) {
      ...
      if (next_timestamp - sensor_data[0] > 600000000) {
